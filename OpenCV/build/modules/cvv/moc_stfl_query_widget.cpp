...
void cvv::qtutil::STFLQueryWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&STFLQueryWidget::filterSignal)) {
                *result = 0;
            }
        }
        {
            typedef void (STFLQueryWidget::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&STFLQueryWidget::userInputUpdate)) {
                *result = 1;
            }
        }
        {
            typedef void (STFLQueryWidget::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&STFLQueryWidget::requestSuggestions)) {
                *result = 2;
            }
        }
        {
            typedef void (STFLQueryWidget::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&STFLQueryWidget::showHelp)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject cvv::qtutil::STFLQueryWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cvv__qtutil__STFLQueryWidget.data,
      qt_meta_data_cvv__qtutil__STFLQueryWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cvv::qtutil::STFLQueryWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cvv__qtutil__STFLQueryWidget.stringdata0))
        return static_cast<void*>(const_cast< STFLQueryWidget*>(this));
